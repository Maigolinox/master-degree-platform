...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r'])) {
  ...
  if ($password==$password_r){
    ...
    if ($count == 0){
      ...
      $conn->query("INSERT INTO `users` (`users_name`,`users_email`, `users_password`) VALUES ('".$name."','".$email."', '".$password."');");
      $asunto="REGISTRO EN PLATAFORMA DE PRE-INSCRIPCIÓN UTT POSGRADO";
      $mensaje1="Tus datos son los siguientes: Correo y contraseña separados por coma";
      $mensaje2=": ";
      $coma=" , ";
      $mensaje=$mensaje1.$mensaje2.$email.$coma.$password_r;
      $header="From: vicmictm@gmail.com"."\r\n";
      $header.="Reply-to: vicmictm@gmail.com"."\r\n";
      $header.="X-Mailer: PHP/".phpversion();
      $mail=@mail($email,$asunto,$mensaje,$header);
      if ($mail) {
        $msg.="Usuario creado correctamente se le mandó un correo con sus datos, ingrese haciendo  <a href='index.php'class='text-primary _600' align='center'>clic aquí</a> <br>";
      }else{
      $msg.="Usuario creado correctamente no se mandaron los datos a su email, ingrese haciendo  <a href='index.php'class='text-primary _600' align='center'>clic aquí</a> <br>";
      }
  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form method="post" target="register.php" name="form">
        ...
        <div class="md-form-group">
          <input name="name" type="text" class="md-input" value="<?php echo $name; ?>" required>
          <label>Nombre</label>
        </div>
        <div class="md-form-group">
...
<br>
    <div class="p-v-lg text-center">
      <div>¿Ya tienes una cuenta? <a ui-sref="access.signin" href="index.php" class="text-primary _600">Entra</a></div>
    </div>
  </div>
